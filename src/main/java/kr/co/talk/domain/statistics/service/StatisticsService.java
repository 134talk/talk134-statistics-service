...
public class StatisticsService {
    ...
    private List<NicknameRankingResponseDto.Type1> getType1List(List<String> nicknameList) {
        ...
        Map<String, String> top3ValuePercentage = eachPercentage(valueList);
    ...
    private List<NicknameRankingResponseDto.Type2> getType2List(List<String> nicknameList) {
        ...
        Map<String, String> top3ActPercentage = eachPercentage(valueList);
    ...
    private List<NicknameRankingResponseDto.Type3> getType3List(List<String> nicknameList) {
        ...
        Map<String, String> top3StatusPercentage = eachPercentage(valueList);
    ...
    private static Map<String, String> eachPercentage(List<String> valueList) {
        ...
        for (Map.Entry<String, Integer> entry : sortedEntries) {
            ...
            percentageMap.put(entry.getKey(), formattedPercentage);
            count++;
    ...
    private String actValue (String act) {
        ...
        if (act.equals("t")) {
            ...
            value = "열정적인 목표 달성과 리더쉽";
        } else if (act.equals("a")) {
            value = "나름의 계획과 효율이 중요한";
        } else if (act.equals("d")) {
            value = "힘을 빼고, 유쾌하게 평균 이상";
